...
function PANEL:Init()
	...
	self.Sc:SetText( "Singularity ScoreBoard" )
	...
	Singularity.Utl:SetupThinkHook("ScoreboardUpdater",1,0,function() 
...
function PANEL:PerformLayout()
	...
	self.lblTeam:SetPos( self:GetWide() - 45*10.2 - self.lblTeam:GetWide()/2, self.PlayerFrame.y - self.lblPing:GetTall() - 3  )
end
...
vgui.Register( "SingularityBoard", PANEL, "Panel" )
