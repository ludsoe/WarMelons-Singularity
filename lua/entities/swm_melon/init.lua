...
function ENT:RunOrders()
	if table.Count(self.Orders)<=0 then return end
...
util.AddNetworkString('MelonsSyncOrders')
util.AddNetworkString('MelonsSyncOrderComplete')
util.AddNetworkString('MelonsClearOrders')
